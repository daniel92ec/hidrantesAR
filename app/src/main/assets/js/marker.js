...
function Marker(poiData) {
    ...
    */
    ...
    this.locationHolder = markerLocation;
    ...
    // NEW
    // create an AR.Label for the distance to User
    this.distanceLabel = new AR.Label(disLocationString, 0.9, {
        zOrder: 1,
        translate: {
             y: -0.55
         },
    ...
    */
    this.directionIndicatorDrawable = new AR.ImageDrawable(World.markerDrawable_directionIndicator, 0.06, {
        enabled: true,
    ...
    */
    this.markerObject = new AR.GeoObject(markerLocation, {
        drawables: {
            cam: [this.markerDrawable_idle, this.markerDrawable_selected, this.titleLabel, this.descriptionLabel, this.distanceLabel],
...
Marker.prototype.setSelected = function(marker) {
    ...
    console.log('Marker Seleccionado');
...
Marker.prototype.setDeselected = function(marker) {
    ...
    console.log('Item Des Seleccionado');
